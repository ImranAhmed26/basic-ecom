...
const ContactSendmsg = () => {
  return (
    <div className="py-2">
      <div className="w-full h-15 grid grid-cols-2 flex justify-between px-16">
        <div className="text-xl px-10 flex flex-col items-center">
          <div>
            <div>Find us here</div>
            <div className="py-10 text-lg font-normal w">
              <p>Address</p>
              <p>Dhaka, Bangladesh</p>
              <p>Email : rmgstock@nitbgroup.com</p>
              <p>Phone+88 01841 933 577</p>
            </div>
          </div>
        </div>
        <div className="">
          <form class="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-blue-500 ">
            ...
            <input
              type="text"
              name="fullname"
              class="bg-transparent border-b py-2 pl-4 focus:outline-none focus:rounded-md focus:ring-1 ring-violet-500 font-light text-gray-500"
            />
